    ...
    Welcome = function()
            ...
            " "
                ..
                        ...
                        Gamename.. "!" .. " Red Hub]"  .."\n Loadded Succesfully dev script by RO OD #9999"
            )
    end
}
}
...
game.StarterGui:SetCore("SendNotification", {
    Icon = "";
    Title = "Red Hub", 
    Text = "welecome Red Hub HUB"
})

wait(1)
_G.SchemeColor = Color3.fromRGB(255,0,0)
...
local Window = library:CreateWindow('Red HUB',library.themes.original,Enum.KeyCode.RightControl)
...
Tab1ss:CreateButton("Super Fastattack", function()
...
_G.FastAttack2 = true
Tab1ss:CreateToggle("Fast Attack",true,function (d)
    _G.FastAttack2 = d
end)
